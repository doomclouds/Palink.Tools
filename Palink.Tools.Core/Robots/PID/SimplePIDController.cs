...
/// </remarks>
public sealed class SimplePIDController
{
    public SimplePIDController(double gainProportional, double gainIntegral,
    ...
    public double ControlVariable(TimeSpan timeSinceLastUpdate)
    {
        ...
        var dInput = ProcessVariable - ProcessVariableLast;
        var derivativeTerm =
