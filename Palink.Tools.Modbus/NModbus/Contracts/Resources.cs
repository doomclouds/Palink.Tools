...
internal static class Resources
{
    ...
    public const string GatewayPathUnavailable =
    ...
    public const string GatewayTargetDeviceFailedToRespond =
    ...
    public const string HexCharacterCountNotEven =
        "Hex string must have even number of characters.";

    public const string IllegalDataAddress =
    ...
    public const string MemoryParityError =
    ...
    public const string NetworkBytesNotEven =
        "Array networkBytes must contain an even number of bytes.";

    public const string SlaveDeviceBusy =
    ...
    public const string SlaveDeviceFailure =
        "An unrecoverable error occurred while the server(or slave) was attempting to perform the requested action.";

    public const string SlaveExceptionResponseFormat =
        "Function Code: {1}{0}Exception Code: {2} - {3}";

    public const string SlaveExceptionResponseInvalidFunctionCode =
        "Invalid function code value for SlaveExceptionResponse.";

    public const string TimeoutNotSupported =
        "The compact framework UDP client does not support timeouts.";

    public const string UdpClientNotConnected =
        "UdpClient must be bound to a default remote host. Call the Connect method.";

    public const string Unknown = "Unknown slave exception code.";

    public const string WaitRetryGreaterThanZero =
        "WaitToRetryMilliseconds must be greater than 0.";
}