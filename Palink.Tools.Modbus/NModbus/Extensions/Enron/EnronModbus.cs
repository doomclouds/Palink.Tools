...
internal static class EnronModbus
{
    ...
    public static uint[] ReadHoldingRegisters32(this IModbusMaster master,
        byte slaveAddress,
        ushort startAddress,
    ...
    public static uint[] ReadInputRegisters32(this IModbusMaster master,
        byte slaveAddress,
        ushort startAddress,
        ushort numberOfPoints)
    {
    ...
    public static void WriteSingleRegister32(this IModbusMaster master,
        byte slaveAddress,
        ...
        uint value)
    {
        ...
        master.WriteMultipleRegisters32(slaveAddress, registerAddress, new[]
        {
            value
        });
    }
    ...
    public static void WriteMultipleRegisters32(this IModbusMaster master,
        byte slaveAddress,
        ushort startAddress,
        uint[] data)
    {
        ...
        ushort maxNumberOfPoints)
    {
        ...
        {
            var msg =
                $"Argument numberOfPoints must be between 1 and {maxNumberOfPoints} inclusive.";
